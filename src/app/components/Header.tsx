      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <a href="#" className="flex items-center gap-3 group">
            ...
            <span className="font-bold text-[#00BF7F] text-[38px] tracking-tight leading-none font-['Raleway',sans-serif]">
              SYMPLE
            </span>
          </a>
      ...
      {mobileMenuOpen && (
        ...
        >
          <div className="px-6 py-6 space-y-4">
            ...
            <a href="https://apps.apple.com/kr/app/%EC%98%A4%EB%A6%AC%EC%9D%98-%EA%BF%88/id6746451155" target="_blank" rel="noopener noreferrer" className="w-full">
